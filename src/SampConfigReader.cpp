...
bool ServerConfigReader::GetVar(string varname, string &dest)
{
	varname += ' ';
...
bool ServerConfigReader::GetVarList(string varname, vector<string> &dest)
{
	dest.clear();
...
bool ServerConfigReader::GetGamemodeList(vector<string> &dest)
{
	string
		varname("gamemode"),
		value;
